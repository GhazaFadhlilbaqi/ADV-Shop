...
public class PaymentServiceImpl implements PaymentService{
    ...
    public Payment addPayment(Order order, String method, Map<String, String> paymentData){
        ...
        if (savedPayment == null || !savedPayment.getStatus().equals(PaymentStatus.SUCCESS.getDisplayName())){
            Payment payment = new Payment(order.getId(), method, PaymentStatus.PENDING.getDisplayName(), paymentData);
